...
## -*- texinfo -*-
## @deftypefn {Function File} {@var{r} = } __thin_fun2__ (@var{X})
## Calculates the results of the second iteration for
...
## as second stage for thin morphological operation to create a
## LUT using makelut.
##
## Returns 0 if the central pixel is deleted after the second
