...
##
## We add 'inst/private' because some m files that are conditionally
## generated by 'src/Makefile' need private functions to work.  This
## is not an ideal solution but for testing purposes should work fine.
PATH_ARGS = --path 'inst/' --path 'src/' --path 'inst/private/'
